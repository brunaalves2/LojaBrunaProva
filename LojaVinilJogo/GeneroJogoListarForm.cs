...
{
    public partial class GeneroJogoListarForm : Form
    {
        public GeneroJogoListarForm()
        {
            InitializeComponent();
        ...
        void Listar()
        {
            var info = new GeneroDAO("GeneroJogo").Listar();
        ...
        private void alterarGeneroButton_Click(object sender, EventArgs e)
        {
            ...
            new GeneroJogoForm(generoSelecionado).ShowDialog();
            Listar();
        }

        private void inserirGeneroButton_Click(object sender, EventArgs e)
        {
            new GeneroJogoForm().ShowDialog();
            Listar();
        }

        private void GeneroJogoListarForm_Shown(object sender, EventArgs e)
        {
        ...
        private void excluirGeneroButton_Click(object sender, EventArgs e)
        {
            ...
            if (idMarcado > 0)
            {
                ...
                {
                    var resp = new GeneroDAO("GeneroJogo").Excluir(idMarcado);
                    if (resp == false)
